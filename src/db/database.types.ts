  ...
  public: {
    Tables: {
      ...
      sale_departments: {
        ...
        Relationships: [
          {
            foreignKeyName: "sale_departments_department_id_fkey"
          ...
          {
            foreignKeyName: "sale_departments_sale_id_fkey"
            columns: ["sale_id"]
            isOneToOne: false
      ...
      sales: {
        Row: {
          ...
          created_at: string
          hammer_total: number | null
          id: string
          imported_at: string | null
          insurance: number | null
          lot_charges: number | null
          lots_auctioned: number | null
          lots_sold: number | null
          lots_unsold: number | null
